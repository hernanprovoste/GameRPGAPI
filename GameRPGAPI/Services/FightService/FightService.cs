...
namespace GameRPGAPI.Services.FightService
{
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                if (attacker is null || opponent is null || attacker.Skills is null) throw new Exception("Something fishy in going on here...");
        ...
        public async Task<ServiceResponse<AttackResultDto>> WeaponAttack(WeaponAttackDto request)
        {
            ...
            try
            {
                ...
                if (attacker is null || opponent is null || attacker.Weapon is null) throw new Exception("Something fishy in going on here...");
